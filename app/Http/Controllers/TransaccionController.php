...
class TransaccionController extends Controller
{
    ...
    public function graciasQR(Request $request){
        ...
        $imagen = \QrCode::format("png")->generate('https://comparadordeventas.com/pagolibre/public/nuevoEstado/13/$2y$10$TvsMCB0tPCqq8OUmVfMAc.EBc7gK0S88AQiCSiiEcYamlz93VXLFe/1', '../public/qrcodes/13.png');
